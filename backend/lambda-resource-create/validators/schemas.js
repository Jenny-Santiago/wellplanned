                ...
                workloads: {
                    ...
                    items: {
                        ...
                        properties: {
                            ...
                            responsable_email: { type: 'string', format: 'email' }
                        },
                        required: ['fecha_inicio', 'fecha_fin', 'sdm', 'status', 'responsable_email'],
...
exports.WL_I_SCHEMA = {
    ...
    properties: {
        ...
        contenido: {
            ...
            required: ['id_cliente', 'fecha_inicio', 'fecha_fin', 'sdm', 'status', 'responsable_email'],
            additionalProperties: false
        }
    },
    required: ['operacion', 'contenido'],
